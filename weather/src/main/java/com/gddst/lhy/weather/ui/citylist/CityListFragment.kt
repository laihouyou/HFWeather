...
import com.gddst.lhy.weather.ui.citysearch.CitySearchFragment2
...
class CityListFragment2 : BaseVmFragment<CityListViewModel>(){
...
//    }
    ...
    override fun observe() {
        super.observe()
        mViewModel.run {
            weathervoList.observe(viewLifecycleOwner, Observer {
                weatherVoList.clear()
                weatherVoList.addAll(it)
                setListDate()
            })
        }
    }
...
//    }
    ...
    override fun viewModelClass(): Class<CityListViewModel> {
